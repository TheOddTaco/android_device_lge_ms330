...
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.console=ttyHSL0 user_debug=31 msm_rtb.filter=0x3F ehci-hcd.park=3 androidboot.bootdevice=7824900.sdhci lpm_levels.sleep_disabled=1 earlyprintk androidboot.hardware=m1 vmalloc=400m bootcable.type=NO_INIT androidboot.ddr_size=1610612736 androidboot.baseband=msm mdss_mdp3.panel=1:dsi:0:qcom,mdss_dsi_lgd_incell_ssd2068_fwvga_video:1:none
